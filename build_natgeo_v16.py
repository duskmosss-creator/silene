...
print("Building 3-volume National Geographic ZIM collection (v16)...")
...
def build_vol(pdf_list, vol_num, title, subtitle, name_meta):
    zim_out = f"zim_downloads/National_Geographic_Vol{vol_num}_v16.zim"
