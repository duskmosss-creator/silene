...
# The complete list of old + new articles
natgeo_archive_list = [
    {
...
for item in natgeo_archive_list:
    ...
    cover_img_path = item.get('cover', '')
    
    # Check cover existence - fallback if missing
    if not os.path.exists(f"{natgeo_dir}/{cover_img_path}"):
        cover_img_path = "images/nationalgeograph11889nati_cover.jpg"
    ...
    <div class="container">
        <section class="controls">
            ...
            <div class="filter-tabs" id="filterTabs">
                <div class="tab active" data-category="ALL">All Topics</div>
...
print("NatGeo static index built using original display layout, including all new PDF articles.")
