    ...
    <div class="header">
      ...
      <div class="scroll-container" id="pdfScrollContainer">
        <div style="width: 100%; text-align: center; margin-bottom: 1rem;">
            <a href="{aid}.pdf" target="_blank" style="display: inline-block; background: var(--accent); color: #0f172a; padding: 0.75rem 1.5rem; border-radius: 8px; font-weight: 700; text-decoration: none;">📄 Open / Download Raw PDF Document Directly ({aid}.pdf)</a>
        </div>
